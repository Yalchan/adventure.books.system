...
import com.advanced.academy.adventure.books.system.model.dto.BittrexTickerResponse;
...
public class TestService {
    ...
    public String testPayPalCapture() {
        ...
        try {
            ...
            return e.getResponseBodyAsString()+e.getStatusText()+e.getStatusCode();
        }
    }
    ...
    public BittrexTickerResponse getBittrexTicker(){
        return restTemplate.getForObject("https://api.bittrex.com/api/v1.1/public/getticker?market=USD-BTC",
